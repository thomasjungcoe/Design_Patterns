...
// "Factory Mehod" is a creational design pattern which solves the problem of creating product objects without specifying their concrete classes.
...
/**
 * The producct interface declares the operations that all concrete products must implement. 
 */
class Product {
    public:
        virtual ~Product() {}
...
class Creator {
    /**
    * The Creator class declares the factory method that is suppoed to return an obj of a Product class.
    * The Creator's subclasses usually provide the implementation of this method.
    */
    public:
        virtual ~Creator() {}
        ...
        /**
         * also note that, despite its name, the Creator's primary responsibility isn't creating products.
...
/**
 * Concrete Creators override the factory method in order to change the result product's type.
*/
