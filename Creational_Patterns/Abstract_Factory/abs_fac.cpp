// Conceptual Example: Abstract Factory
 ...
 * These products are called a family and are related by a high-level theme or concepts. Products of one family are usually able to collaborate among themselves.
 * A family of products may have serveral vraiants, but the products of one variant are incompatible with products of another variant.
*/
 ...
 * The factory guarantees that resulting products are compatible. Note that signatures of the Concrete Factory's methods return an abstract product,
...
/**
 * The client code works with factories and products only through abstract type: AbstractFactory and AbstractProduct.
